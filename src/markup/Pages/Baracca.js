...
import Tablist from './../Element/TablistBaracca';


var bnr = require("./../../images/listing/baracca.jpeg")
							...
							<div className="listing-info-box" >
								...
								<div className="listing-info">
									<div className="listing-info-left">
										<h3 className="title">Baracca</h3>
										<p>Restaurant sofisticat ce servește preparate contemporane creative cu influențe internaționale.</p>
									</div>
